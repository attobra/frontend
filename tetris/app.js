document.addEventListener('DOMContentLoaded', ()=> {
  ...
  let random2 = Math.floor(Math.random()*theTetrominos.length);
  console.log(random);
  ...
  function freeze(){
    ...
    .classList.contains('taken'))){
      current.forEach(index => squares[currentPosition + index + width]
      .classList.add('taken'))
  ...
  //move the tetromino left unless is at the edge or there is a blocakge
  function moveLeft(){
    undraw();
